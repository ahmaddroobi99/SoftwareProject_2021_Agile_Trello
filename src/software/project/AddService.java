...
public class AddService extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("ACCOUNT NUMBER FOR SERVICE:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String serviceName = this.jTextField1.getText();
        String accountNum = this.jTextField2.getText();
        if(serviceName.isEmpty() || accountNum.isEmpty()){
            JOptionPane.showMessageDialog(rootPane, "Please fill all required fields","Error",JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        try {
            boolean done = AdminController.addService(serviceName, accountNum);
            if(done){
